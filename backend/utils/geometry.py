...
BREED_PROFILES = {
    "minhota": {
        ...
        "body_length_ratio": 1.16,
        "thoracic_ratio": 0.52,
        "rump_ratio": 0.40,
    },
    "alentejana": {
        "withers_height_cm": 135.0,
        "body_length_ratio": 1.19,
        "thoracic_ratio": 0.54,
        "rump_ratio": 0.42,
    },
    "barrosã": {
        "withers_height_cm": 124.0,
        "body_length_ratio": 1.14,
        "thoracic_ratio": 0.51,
        "rump_ratio": 0.39,
    },
    "maronesa": {
        "withers_height_cm": 122.0,
        "body_length_ratio": 1.13,
        "thoracic_ratio": 0.50,
        "rump_ratio": 0.38,
    },
    "cachena": {
        "withers_height_cm": 112.0,
        "body_length_ratio": 1.10,
        "thoracic_ratio": 0.48,
        "rump_ratio": 0.36,
    },
    "mirandesa": {
        "withers_height_cm": 132.0,
        "body_length_ratio": 1.18,
        "thoracic_ratio": 0.53,
        "rump_ratio": 0.41,
    },
    "default": {
        "withers_height_cm": 130.0,
        "body_length_ratio": 1.17,
        "thoracic_ratio": 0.53,
        "rump_ratio": 0.41,
    },
}
...
def bbox_to_measurements(bbox, img_h, img_w, breed="default"):
    ...
    body_length = round(
        (bbox_w_px / px_per_cm) * profile["body_length_ratio"]
        + np.random.uniform(-4, 4),
        1,
    )
    thoracic_depth = round(
        withers_height * profile["thoracic_ratio"] + np.random.uniform(-2, 2), 1
    )
    rump_width = round(
        withers_height * profile["rump_ratio"] + np.random.uniform(-1.5, 1.5), 1
    )
    # Perímetro torácico estimado via fórmula empírica da literatura
    chest_girth = round(
        2.1 * thoracic_depth + 1.3 * rump_width + np.random.uniform(-5, 5), 1
    )

...
class ExternalTrainingPipelineTests(unittest.TestCase):
    ...
    def test_normalizer_maps_measurements_workbook_headers(self):
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            result = normalize_external_dataset(input_path, dataset_source="Measurements")
    ...
    def test_normalizer_flags_database2022v2_rows_without_body_length(self):
        with tempfile.TemporaryDirectory() as temp_dir:
            input_path = Path(temp_dir) / "database2022v2.csv"
            self.write_csv(
                input_path,
                [
                    "N",
            ...
            result = normalize_external_dataset(input_path, dataset_source="Database2022v2")
